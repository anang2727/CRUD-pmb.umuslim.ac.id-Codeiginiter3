    ...
    <form id="form" method="post">
      ...
      <div class="row">
        ...
        <div class="col-sm-3">
          <div class="form-group">
            ...
            <input type="text" name="suku" class="form-control" placeholder="Masukan Tempat Lahir" />
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
      ...
      <div class="row">
        ...
        <div class="col-sm-3">
          ...
          <div class="form-grup">
            <div class="form-check">
              <input required class="form-check-input" value="Laki-Laki" type="radio" name="jenis_kelamin" id="laki" />
        ...
        <div class="col-sm-3">
          <div class="form-group">
            ...
            <input type="text" name="tinggi" class="form-control" placeholder="Berat Badan Anda" />
          </div>
        </div>
      </div>
      <!--  -->
      ...
      <div class="row">
        ...
        <div class="col-sm-3">
          ...
          <div class="form-grup">
            <div class="form-check">
              <input class="form-check-input" type="radio" name="status" id="flexRadioDefault100" />
              <label class="form-check-label" for="flexRadioDefault100">Kawin</label>
            </div>

            <div class="form-check">
              <input class="form-check-input" type="radio" name="status" id="flexRadioDefault122" />
      ...
      <div class="row">
        ...
        <div class="col-sm-4 offset-4">
          ...
          <input type="password" class="form-control" id="customFile" />
        </div>
        <div class="col-sm-4 offset-4">
          <label class="form-label" for="customFile">Ulangi Password</label>
          <input type="text" class="form-control" id="customFile" />
          <br>
        </div>
      </div>
